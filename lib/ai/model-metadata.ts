...
const THINKING_CAPABILITIES: Record<string, ThinkingCapability> = {
  ...
  [getModelMetadataKey('agnes-ai', 'agnes-2.5-flash')]: deepseekEffort,
  [getModelMetadataKey('agnes-ai', 'agnes-2.5-pro')]: deepseekEffort,
  [getModelMetadataKey('agnes-ai', 'agnes-2.5-pro-alpha')]: deepseekEffort,
